import { Time, WeekDate, Event, EventOption, TimeInterval } from '../src/suppClasses'
...
describe('Shedule', function(){
	...
	const ACAT1 = new EventOption(ACAT, 1,[ new TimeInterval( new WeekDate(4,new Time(9,0)) , new WeekDate(4,new Time(11,0))), ]);
